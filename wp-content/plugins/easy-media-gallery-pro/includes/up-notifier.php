...
define( 'EMG_NOTIFIER_PLUGIN_XML_FILE', 'http://s3.ghozylab.com/update/plugins/emg-pro/notifier.xml' ); // The remote notifier XML file containing the latest version of the plugin and changelog
