...
function spg_add_admin() {
	 if ( isset($_POST['_wp_http_referer']) && strpos( $_REQUEST['_wp_http_referer'], 'post_type=easymediagallery&page=emg_settings' ) !== FALSE && isset( $_REQUEST['_wpnonce'] ) && check_admin_referer( 'easy_options_group-options' ) ) {
...
if ( is_admin() && ( isset( $_GET['page'] ) == 'emg_settings' ) && ( isset( $_GET['post_type'] ) == 'easymediagallery' ) ){
	...
	//wp_enqueue_script( 'jquery-ui-custom-1' );
    ...
    <div id="header">
      <div class="logo">
       <div class="icon-option-left"></div>
        <div class="emg-cp-title"><h2><?php echo $emgplugname . "  (v " . easymedia_get_plugin_version() . ")"; ?></h2></div>
      </div>
