...
echo '<div id="medsingimgtut" style="text-decoration:underline;font-weight:bold;cursor:Pointer; color:#1A91F2 !important; margin-bottom:8px;">Video Tutorial</div><td id="imgupld"><input id="upload_image" type="text" name="easmedia_meta['. $field['id'] .']" value="'. ($meta ? $meta : $field['std']) .'" style="margin-bottom:5px;"/><div style="color:red;" id="notifynovalidimg"></div><div class="addmed">
<a rel="image-'.$emgepver.'" class="' . $uploaderclass . '" title="Add Media" '.$isdatacnt.' href="'.$emghref.'"><span class="emg-media-buttons-icon"></span>Add Media</a></div>
...
<td id="audioupld"><input id="upload_audio" type="text" name="easmedia_meta['. $field['id'] .']" value="'. ($meta ? $meta : $field['std']) .'" style="margin-bottom:5px;"/><div style="color:red;" id="notifynovalidaudio"></div><div class="addmed"><a rel="audio-'.$emgepver.'" class="' . $uploaderclass . '" title="Add Media" '.$isdatacnt.' href="'.$emghref.'"><span class="emg-media-buttons-icon"></span>Add Media</a></div>
...
if ( get_post_type( get_the_ID() ) == 'easymediagallery' && EMG_WP_VER == "l35" ) {
...
function easmedia_metabox_work(){
	...
	// SINGLE IMAGE/GALLERY IMAGE THUMBNAIL (FOR ALL MEDIA) 
		...
		'fields' => array(
			...
			array(				 
					'name' => __( 'Auto Generated Youtube/Vimeo Thumbnail', 'easmedia' ),
					'desc' => __( 'If ON, Easy Media Gallery Pro will fetch default thumbnail for Youtube or Vimeo video.', 'easmedia' ),
					'id' => 'easmedia_metabox_media_video_fetch',
					'type' => 'checkboxoptdeffetch',
					'dvi' => 'easmedia_metabox_media_video_fetchurl',
					'defflimit' => '0',
					'std' => 'off'
					),	
