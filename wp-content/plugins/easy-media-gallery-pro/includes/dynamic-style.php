...
echo '.da-thumbs article.da-animate p, p.da-animatenh {color:'.$ttlcol.' !important;}';
...
if ( $thumbttlpos == 'Top' ) {	
echo 'p.da-animatenh, .da-thumbs article.da-animate p{margin-top: 0px !important; top:0px;}';
}
else if ( $thumbttlpos == 'Bottom' ) {	
echo 'p.da-animatenh, .da-thumbs article.da-animate p{margin-bottom: 0px !important; bottom:0px;}';
}
...
#mbsosmed ul #sosmedgp span {
	background: url(../css/images/sprite_sosmed.png) no-repeat -79px -0px transparent;	
	opacity: 0.7;	
}

#mbsosmed ul #sosmedgp span:hover {
	background: url(../css/images/sprite_sosmed.png) no-repeat -79px -25px transparent;		
}

#mbsosmed ul #sosmedeml span {
	background: url(../css/images/sprite_sosmed.png) no-repeat -105px 0px transparent;	
	opacity: 0.7;	
}

#mbsosmed ul #sosmedeml span:hover {
	background: url(../css/images/sprite_sosmed.png) no-repeat -105px -25px transparent;		
}';
}
...
// Badge Color
echo 'span.emg-badges{background:url(../css/images/badges/'.easy_get_option( 'easymedia_badge_col' ).'.png); background-repeat:no-repeat; background-position:center;
}';	
